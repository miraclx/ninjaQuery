...
module.exports.email = opts => ninjaQuery(xSettle(defaults.email, opts));
module.exports.confirm = opts => ninjaQuery(xSettle(defaults.confirm, opts));
module.exports.extend = (type, opts) => ({...defaults[type], ...opts});
